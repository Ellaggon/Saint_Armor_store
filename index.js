import { madeCategoryCards } from "./categoryCards.js";
import { products } from "./products.js";
import recomendedCards from "./recomendedCards.js";

const d = document;

// function change() {
//   const $categoryRadios = d.querySelectorAll('[name="categories"]'),
//     $post = d.querySelectorAll('.post');
  
//   $categoryRadios.forEach(radio => {
//     radio.addEventListener("change", e => {
//       const selectedCategory = d.querySelector('[name="categories"]:checked').value;
  
//       $post.forEach(post => {
//         if (selectedCategory === 'TODOS' || post.dataset.category.includes(selectedCategory)) {
